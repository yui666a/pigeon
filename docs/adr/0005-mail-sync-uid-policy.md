...
- `docs/superpowers/specs/2026-04-12-pigeon-design.md`（Pigeon 全体設計 / 双方向同期表）
- `docs/superpowers/specs/2026-07-12-read-unread-design.md`（既読/未読と IMAP フラグ同期）
- `docs/superpowers/specs/2026-07-12-mail-delete-archive-design.md`（メール削除・アーカイブのサーバー反映）
- `docs/superpowers/specs/2026-07-12-sent-sync-uidplus-design.md`（Sent 同期 + UIDPLUS / APPENDUID / COPYUID）
- `docs/superpowers/specs/2026-07-12-star-flag-unread-design.md`（スター/フラグ・手動で未読に戻す）
- `docs/superpowers/specs/2026-07-13-bulk-actions-design.md`（複数選択・一括操作 / `plan_*` 複製メモ）
